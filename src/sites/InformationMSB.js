...
d) promowanie skutecznego dwustronnego komunikowania się biegłego rewidenta z osobami sprawującymi nadzór.`,
        ...
        {
            lp: 10,
            standard: "KSRF 315 (Zmieniony) – identyfikacja i ocena ryzyk istotnego zniekształcenia dzięki zrozumieniu jednostki i jej otoczenia",
            zastosowanie: "Stosuje się w każdym badaniu.",
...
b) wpływu nieskorygowanych zniekształceń, jeśli takie występują, na sprawozdania finansowe.`,
        ...
        },
        {
            ...
            {
                lp: 27,
                standard: "KSRF 610 (Zmieniony) – Wykorzystanie pracy audytorów wewnętrznych",
                                ...
                                if (r.type === "section") {
                                    ...
                                    return (
                                        <tr key={r.lp}>
                                            ...
                                            <td>{r.standard}</td>
                                            <td>{r.zastosowanie}</td>
                                            <td style={{ whiteSpace: "pre-wrap" }}>{r.cele}</td>
